...
``` r
#output: can be html_document (toc: true toc_float: true), pdf_document, word_document, github_document
```
...
I can take the mean of the sample, too! The mean is -0.1670821.
...
![](template_practice_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->![](template_practice_files/figure-gfm/unnamed-chunk-4-2.png)<!-- -->
...
![](template_practice_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
![](template_practice_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
